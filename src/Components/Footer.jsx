    ...
    return(
        <Container fluid id="Links" className="footerContainer">
            <Row className="text-center position-relative top-50">
                ...
                <Col><a href="https://github.com/Zryer" target="blank"><IconGITHUB /></a></Col>
                <Col><a href="https://www.linkedin.com/in/zachary-fisher-1b6448221/" target="blank"><IconLINKEDIN /></a></Col>
            </Row>
        </Container>
    )
}
